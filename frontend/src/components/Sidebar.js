  ...
  return (
    <div className="sidebar">
      ...
      <nav className="sidebar-nav">
        ...
        <NavLink to="/schedule" className="nav-link disabled-link" onClick={(e) => e.preventDefault()}>
        ...
        <NavLink to="/payments" className="nav-link disabled-link" onClick={(e) => e.preventDefault()}>
